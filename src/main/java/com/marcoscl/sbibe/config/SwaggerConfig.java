...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
			// desabiltiar respostas padrao
				.useDefaultResponseMessages(false)
			// passando lista de respostas personalizadas
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.marcoscl.sbibe.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
			...
			"Esta API é utilizada no curso de Spring Boot do mr. Marcos Lima",
			"Versão 1.0",
			"https://github.com/MarcosACLima",
			new Contact("Marcos Lima", "udemy.com/user/anonymous", "marcos@gmail.com"),
