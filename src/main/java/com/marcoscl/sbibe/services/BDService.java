...
public class BDService {
	...
	public void instanciarTesteBancoDado() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "111222333-00", TipoCliente.PESSOAFISICA, cpe.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "316283827-40", TipoCliente.PESSOAFISICA, cpe.encode("123456"));
